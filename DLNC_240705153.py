...
dll.display_forward()  # 5 10 20 25 30

print('Menambahkan simpul 17 setelah simpul 10:')
dll.insert_after(17, 10)
dll.display_forward()  # 5 10 17 20 25 30
print()
...
dll.delete_from_end()
dll.display_forward()  # 10 17 20 25
print()

print('Delete simpul 20')
dll.delete_at_middle(20)
dll.display_forward()  # 10 17 25
print('Data dari belakang ke depan:')
dll.display_backward() # 25 17 10